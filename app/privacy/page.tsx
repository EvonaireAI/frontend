...
const PRIVACY_POLICY_EMBED_URL = "https://docs.google.com/document/d/e/2PACX-1vSJTVzLVd_GRZmOIkzFr6QFEICiLejBTcomzkDtDvhHFetBQ3mEDZNGnJoWQfJSgbGbqzTCuN2e-Thl/pub?embedded=true"
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card className="bg-dark-navy/50 border-gold/20 shadow-[0_0_30px_rgba(217,181,116,0.1)]">
          <CardHeader className="text-center pb-8">
            ...
            <CardTitle className="text-3xl text-cream font-serif">Privacy Policy</CardTitle>
            <p className="text-cream/60 mt-2">Learn how Evonaire protects and handles your personal information</p>
          </CardHeader>
          <CardContent>
            <div className="rounded-lg border border-gold/20 overflow-hidden bg-white">
              <iframe
                src={PRIVACY_POLICY_EMBED_URL}
                className="w-full border-0"
                style={{ height: "calc(100vh - 350px)", minHeight: "600px" }}
                title="Evonaire Privacy Policy"
                loading="lazy"
